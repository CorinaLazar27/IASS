...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form ID="form1" runat ="server">
        ...
        <br /><br />
        <asp:Label runat="server" Text="Adaugare medicament" Font-Size="13pt" style="margin-left:40%"></asp:Label>
        <br /><br />

        <div style="margin-left:35%">
           <asp:Label runat="server" Text="Denumire" Font-Size="11pt"></asp:Label>
        ...
        <div style="margin-left:35%">
           <asp:Label runat="server" Text="Stoc" Font-Size="11pt"></asp:Label>
